...
def make_backup_files(*,
    ...
    :param hosts(dict, optional): A dictionary containing information about hosts to be backed up
    :param host_defaults(dict, optional): Default values applied to each host (if necessary)
